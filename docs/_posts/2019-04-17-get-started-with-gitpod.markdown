...
![リポジトリ作成ボタン]({{ site.url }}/{{ sute.baseurl }}/images/20190417_010_create_repo1.png)![リポジトリ作成ボタン]({{ site.url }}/{{ sute.baseurl }}/images/20190417_010_create_repo2.png)


リポジトリの名前を決定します。
![リポジトリ名を入力]({{ site.url }}/{{ sute.baseurl }}/images/20190417_020_decide_repo_name.png)

空のリポジトリページができました。
![空のリポジトリ]({{ site.url }}/{{ sute.baseurl }}/images/20190417_030_repository_created.png)
...
![Gitpod dashboard]({{ site.url }}/{{ sute.baseurl }}/images/20190417_100_gitpod_dashboard.png)
...
![gitpod editor]({{ site.url }}/{{ sute.baseurl }}/images/20190417_110_gitpod_editor.png)
...
![プレビュー]({{ site.url }}/{{ sute.baseurl }}/images/20190417_120_gitpod_preview.png)
...
![Gitpod grant]({{ site.url }}/{{ sute.baseurl }}/images/20190417_130_gitpod_grant.png)
